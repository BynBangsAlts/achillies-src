...
public class RenderUtils {
    ...
    public static void drawRect(MatrixStack matrices, float x, float y, float width, float height, int color) {
        ...
        bufferBuilder.vertex(matrix, x, y + height, 0.0f).color(g, h, j, f);
        bufferBuilder.vertex(matrix, x + width, y + height, 0.0f).color(g, h, j, f);
        bufferBuilder.vertex(matrix, x + width, y, 0.0f).color(g, h, j, f);
        bufferBuilder.vertex(matrix, x, y, 0.0f).color(g, h, j, f);
    ...
    public static void rotate(MatrixStack matrices, float rotation, float x, float y) {
